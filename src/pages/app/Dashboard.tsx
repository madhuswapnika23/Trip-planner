...
import { Sparkles, MapPin, Calendar, ArrowRight, Bookmark, Wallet, Plus } from 'lucide-react';
...
export const Dashboard: React.FC = () => {
  ...
  const upcomingTrips = SAVED_TRIPS.filter(t => t.status === 'upcoming');
    ...
    <div className="space-y-8">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-400 max-w-xl">
              You have {upcomingTrips.length} upcoming trip planned. Use our companion tools or create a fresh itinerary.
            </p>
          </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 backdrop-blur-xl">
          ...
          <p className="text-2xl font-bold text-white">{SAVED_TRIPS.length}</p>
          <p className="text-[10px] text-slate-400 mt-1">{upcomingTrips.length} upcoming</p>
        </div>
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 backdrop-blur-xl">
          ...
          <p className="text-[10px] text-slate-400 mt-1">Japan, France, Indonesia, Greece</p>
        </div>
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 backdrop-blur-xl">
          ...
          <p className="text-2xl font-bold text-white">$10,700</p>
          <p className="text-[10px] text-slate-400 mt-1">Across 4 itineraries</p>
        </div>
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 backdrop-blur-xl">
          ...
          <p className="text-[10px] text-slate-400 mt-1">Optimal energy & budget match</p>
        </div>
      </div>
